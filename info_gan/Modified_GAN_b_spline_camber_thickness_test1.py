...
def train(net_D, net_G, data_iter, num_epochs, lr_D, lr_G, latent_dim):
    ...
    trainer_geo = torch.optim.Adam(net_G.parameters(), lr=1e-7)
...
lr_D, lr_G,lr_info, num_epochs = 0.00001, 0.00001, 0.00001, 1000 #50
test_str = '_modified_GAN_test1_' + "%s"%num_epochs
